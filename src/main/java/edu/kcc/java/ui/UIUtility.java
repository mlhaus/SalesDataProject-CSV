...
/**
 * Utility methods for the console user interface.
 *
 * @author Bob Trapp
 */
public class UIUtility {
    ...
    /**
     * Asks the user to enter the parts of a date and then constructs a
     * LocalDate from them.
     *
     * @param prompt the text describing the date
     *
     * @return a LocalDate as entered by the user
     */
    public static LocalDate getUserDate(String prompt) {
        // Get the year
        int yearMin = 1900;
        int yearMax = 2100;
        int year = UIUtility.getUserIntInRange(
                "Enter the four-digit year:"
                , "That is not a whole number."
                , yearMin
                , yearMax
                , "That is not a reasonable year, try "
                        + yearMin + " to " + yearMax
        );
        // Get the month
        int monthMin = 1;
        int monthMax = 12;
        int  month = UIUtility.getUserIntInRange(
                "Enter the month (" + monthMin + "-" + monthMax + "):"
                , "That is not a whole number"
                , monthMin
                , monthMax
                , "That value is not in range."
        );
        // Get the day
        int dayMin = 1;
        int dayMax = 31;
        ...
        int day =  UIUtility.getUserIntInRange(
                "Enter the day of month (" + dayMin + "-" + dayMax + "):"
                , "That is not a whole number"
                , dayMin
                , dayMax
                , "That value is not in range."
